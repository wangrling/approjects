...
namespace GlesSDK {
    ...
    void PlaneModel::getNormals(float **normalsPtrPtr, int *numberOfCoordinatesPtr) {
    ...
    void
    PlaneModel::getTriangleRepresentation(float **coordinatesPtrPtr, int *numberOfCoordinatesPtr,
                                          float scalingFactor) {
        /* Example:
         *  z   D __________ C
         *  .    |        / |
