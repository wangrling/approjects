...
#ifndef APPROJECTS_PROJECTEDLIGHTS_H
...
#define COLOR_TEXTURE_NAME ("/data/user/0/com.android.approjects/files/mail.bmp")
...
#define FRAGMENT_SHADER_FILE_NAME ("/data/user/0/com.android.approjects/files/projected_lights_shader.frag")
...
#define VERTEX_SHADER_FILE_NAME ("/data/user/0/com.android.approjects/files/projected_lights_shader.vert")
...
#endif //APPROJECTS_PROJECTEDLIGHTS_H
