...
public class GlUtil {
    ...
    /**
     * Create a new program from the supplied vertex and fragment shaders.
     */
    ...
    public static int createImageTexture(ByteBuffer data, int width, int height, int format) {
        ...
        GLES30.glTexImage2D(GLES20.GL_TEXTURE_2D, /*level*/ 0, format,
    ...
    public static FloatBuffer createFloatBuffer(float[] coords) {
        // Allocate a direct ByteBuffer, using 3 bytes per float, and copy coords into it.
    ...
    /**
     * Write GL version info to the log.
     */
