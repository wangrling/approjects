...
import com.android.approjects.universalmusicplayer.utils.QueueHelper;
...
public class QueueManager {
    ...
    public QueueManager(MusicProvider musicProvider, Resources resources,
    ...
    public boolean isSameBrowsingCategory(String mediaId) {
        String[] newBrowserHierarchy = MediaIDHelper.getHierarchy(mediaId);
        MediaSessionCompat.QueueItem current = getCurrentMusic();
        if (current == null) {
            return false;
        }

        String[] currentBrowserHierarchy = MediaIDHelper.getHierarchy(
                current.getDescription().getMediaId());

        return Arrays.equals(newBrowserHierarchy, currentBrowserHierarchy);
    }
    ...
    public boolean skipQueuePosition(int amount) {
        ...
        if (!QueueHelper.isIndexPlayable(index, mPlayingQueue)) {
            LogHelper.e("Cannot increment queue index by " + amount +
    ...
    public void setQueueFromMusic(String mediaId) {
        LogHelper.d("setQueueFromMusic " + mediaId);
