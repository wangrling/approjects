...
import com.android.approjects.universalmusicplayer.utils.BitmapHelper;
...
public class AlbumArtCache {
    ...
    public Bitmap getBitmap(String artUrl) {
    ...
    public void fetch(final String artUrl, final FetchListener listener) {
        ...
        final Bitmap[] bitmap = mCache.get(artUrl);
        if (bitmap != null) {
            LogHelper.d("getOrFetch: album art is in cache, using it " + artUrl);
            listener.onFetched(artUrl, bitmap[BIG_BITMAP_INDEX], bitmap[ICON_BITMAP_INDEX]);
            return;
        }
        LogHelper.d("getOrFetch: starting asynctask to fetch " + artUrl);
        ...
        new AsyncTask<Void, Void, Bitmap[]>() {
            ...
            protected Bitmap[] doInBackground(Void... voids) {
                ...
                LogHelper.d("doInBackground: putting bitmap in cache. cache size = " + mCache.size());
    ...
    public static abstract class FetchListener {
        ...
        public void onError(String artUrl, Exception e) {
            LogHelper.e("AlbumArtFetchListener: error while downloading " + artUrl);
        }
    }
}
