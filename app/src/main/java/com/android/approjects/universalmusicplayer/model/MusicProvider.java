...
public class MusicProvider {
    ...
    public void retrieveMediaAsync(final Callback callback) {
        LogHelper.d("retrieveMediaAsync called");
        if (mCurrentState == State.INITIALIZED) {
            if (callback != null) {
    ...
    private synchronized void retrieveMedia() {
        try {
            ...
            if (mCurrentState != State.INITIALIZED) {
                ...
                LogHelper.e("retrieveMedia fail");
    ...
    public List<MediaBrowserCompat.MediaItem> getChildren(String mediaId, Resources resources) {
        ...
        if (MEDIA_ID_ROOT.equals(mediaId)) {
            ...
            for (String genre : getGenres()) {
                mediaItems.add(createBrowseableMediaItemForGenre(genre, resources));
            }
            ...
            LogHelper.d("Skipping unmatched mediaId: " + mediaId);
        }
        return mediaItems;
    }

    private MediaBrowserCompat.MediaItem createBrowseableMediaItemForRoot(Resources resources) {
        MediaDescriptionCompat description = new MediaDescriptionCompat.Builder()
                .setMediaId(MEDIA_ID_MUSICS_BY_GENRE)
                .setTitle(resources.getString(R.string.browse_genres))
                .setSubtitle(resources.getString(R.string.browse_genre_subtitle))
                .setIconUri(Uri.parse("android.resource://" +
                        "com.android.approjects/drawable/ic_by_genre"))
                .build();
