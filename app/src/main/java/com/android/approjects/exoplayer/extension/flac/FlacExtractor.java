...
public final class FlacExtractor implements Extractor {
    ...
    private void readPastStreamInfo(ExtractorInput input) throws IOException {
    ...
    private FlacStreamInfo decodeStreamInfo(ExtractorInput input) throws IOException {
        try {
    ...
    private void outputSeekMap(ExtractorInput input, FlacStreamInfo streamInfo) {
        ...
        SeekMap seekMap =
                hasSeekTable ? new FlacSeekMap(streamInfo.durationUs(), decoderJni)
    ...
    private SeekMap getSeekMapForNonSeekTableFlac(ExtractorInput input, FlacStreamInfo streamInfo) {
        ...
        if (inputLength != C.LENGTH_UNSET) {
            long firstFramePosition = decoderJni.getDecoderPosition();
    ...
    private void outputFormat(FlacStreamInfo streamInfo) {
        Format mediaFormat = Format.createAudioSampleFormat(
                /* id= */ null,
                MimeTypes.AUDIO_RAW,
                /* codecs= */ null,
                streamInfo.bitRate(),
